# %% [markdown]
# <h1><center><b>Simple Linear Regression and Multiple Regression</b></center></h1>
# <hr>
# 
...
nba_wins_df = pd.read_csv('nba_wins_data.csv')  # read the csv file

display(HTML(nba_wins_df.head().to_html()))     # display the first five rows of the dataframe
...
# # ---- TO-DO: make your edits here ----
# correlation_coefficient, p_value = st.pearsonr(['avg_pts'], nba_wins_df['total_wins'])
...
# Multiple Regression
# Adding 'avg_pts' as one of the predictors as per the instructions
...
# # Multiple Regression
# model3 = smf.ols('total_wins ~ avg_elo_n + avg_pts_differential + avg_elo_differential', nba_wins_df).fit()
# # In order to run a multiple regression model, we need to include all the variables in the dataset.
# print(model3.summary()) # print the model 3 summary.

# %% [markdown]
# <hr> 

# %% [markdown]
# <h2><b><center>End of Project Three</b></center></h2>
# <hr>
